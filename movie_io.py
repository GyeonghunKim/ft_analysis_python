...
class frame():
    def __init__(self, datapath, filename, parameter):
        ...
        self.param.set_attr('movie_length', self.length)
    def __del__(self):
        self.__fID.close()
    ...
    def set_currentframe(self, frame_number):
        self.cur_frame = frame_number-1
        
    def set_curframezero(self):
        self.__fID.close()
